  ...
  class MenuCard {
    ...
    render() {
      ...
      if (this.classes.length === 0) {
        /* переденанное количество классов */
...
function form(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', event => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.postData)('http://localhost:3000/requests', json).then(res => {
        console.log(res);
...
function timer(id, deadline) {
  ...
  function getTimeRamaining(endtime) {
    ...
    return {
      ...
      minutes,
      seconds
    }; /* если одинаковые свойства и имя */
  }
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_6__["default"])('.tabcontent', '.tabheader__item', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2022.10.31');
